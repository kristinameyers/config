...
define("tbl_question_answer", TBL_PREFIX."question_answer");
define("tbl_answer", TBL_PREFIX."answer");
define("tbl_emails", TBL_PREFIX."emails");
define("tbl_public_reminder", TBL_PREFIX."public_reminder");
define("tbl_draft", TBL_PREFIX."draft");


//----------------------Start Stripe Configration for Test-------------------------------//

//define("STRIPE_SECRET","sk_test_hf7OqosaMYdhpJbE5s8yi5WI");
//define("STRIPE_PUBLISH","pk_test_Ir5dMFev812wsnO2YahXMUDz");

//define("STRIPE_SECRET","sk_test_5mQN7bLY41wsXW0x1rwj5QGZ");
//define("STRIPE_PUBLISH","pk_test_qG9ltweKNGBlohDcNiSfxNV7");

//----------------------End Stripe Configration for Test-------------------------------//
//define("STRIPE_SECRET","sk_live_xwbsNkcptKtHlaaYIJy6ZIBg");
//define("STRIPE_PUBLISH","pk_live_SUbFZtPLd9bw6ElId9P2AhGB");
//----------------------Start Stripe Configration for Live-------------------------------//
						  
define("STRIPE_SECRET","sk_live_IfK1UpM6Ojaz4RffMndlM1WK");
define("STRIPE_PUBLISH","pk_live_bFkKYyQ7LkN6rTwnNhl7n2j8");

//----------------------End Stripe Configration for Live-------------------------------//
...
/*========================Mail Function==============================*/
	...
	function sendmails($from,$to,$subject,$message){
...
{
	$price_less = $price - ($price * 5/100);
 	$price_add =  $price + ($price * 5/100);
	$price_clause = "AND (price >= '".$price_less."' AND price <= '".$price_add."')";
	return $price_clause;
}
